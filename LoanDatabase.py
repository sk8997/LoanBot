...
class LoanDatabase(object):
    """
    Database object. Executes connection to MySQL Server, creates database and executes all relevant queries

    """

    __db_name = "loan" # Default name for the database
    ...
    def set_connection(self, db_name: str = None) -> None:
        ...
        try: 
            self.connection = mysql.connector.connect(
                    ...
                    database = (db_name if db_exists else None) 
                )
        except Error as err:
    ...
    def create_database(self) -> None:
        ...
        try:
            ...
            cursor.execute("CREATE DATABASE IF NOT EXISTS " + LoanDatabase.__db_name)
        except Error as err:
